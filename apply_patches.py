...
with open('recovered_network.tsx', 'r', encoding='utf-16') as f:
                ...
                if call['name'] == 'replace_file_content':
                    ...
                    if target in args.get('TargetFile', ''):
                        ...
                        if target_content in content:
                            ...
                            print(f"Failed to apply patch: {args.get('Instruction', '')}")
                            # fallback: try to ignore leading/trailing whitespace mismatch
                            import re
...
with open('labs/NetworkInterface31.tsx', 'w', encoding='utf-8') as f:
    f.write(content)
print("Done writing to labs/NetworkInterface31.tsx")
