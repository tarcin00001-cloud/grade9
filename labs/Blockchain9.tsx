...
import { ShieldAlert, Cpu, Pickaxe, AlertTriangle, FileDigit, Link2Off, Database, Lock, Fingerprint, CheckCircle2, Wallet, XOctagon, ArrowRight, MousePointer2, ShieldCheck, Unlock , Timer} from "lucide-react";
...
export default function Blockchain9() {
  ...
  const { reportComplete: _reportComplete } = useLMSBridge("blockchain9");
