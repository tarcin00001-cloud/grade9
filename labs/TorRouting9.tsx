...
import { ShieldCheck, EyeOff, RefreshCcw , Timer} from "lucide-react";
...
const STEP_ORDER = ["IDLE", "NODE1", "NODE2", "NODE3", "TARGET", "DONE"];
...
const [secondsLeft, setSecondsLeft] = useState(TIMER_DURATION_SECONDS);
  ...
  return (
    <LabShell
      ...
      } labId="torrouting9" theme="ocean" title="The Onion Router (TOR) Network" subtitle="L33 · Network Privacy"
      ...
      <div className="w-full flex flex-col flex-1 min-h-0 pt-1 gap-3">
        ...
        {/* Main SVG Area */}
        <div data-step={labCurrentStep} className="flex-1 panel-glass rounded-3xl overflow-x-auto overflow-y-hidden relative border-blue-900/40 bg-[#09090b] shadow-[inset_0_0_80px_rgba(0,0,0,0.9)] flex items-center justify-center">
