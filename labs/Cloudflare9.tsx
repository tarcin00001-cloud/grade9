...
type ServerState = 'idle' | 'active' | 'fire';

const TIMER_DURATION_SECONDS = 5 * 60;

export default function Cloudflare9() {
  const { reportComplete: _reportComplete } = useLMSBridge("cloudflare9");
  ...
  const [serverStates, setServerStates] = useState<ServerState[]>(Array(TOTAL_SERVERS).fill("idle"));
        ...
        interval = setInterval(() => {
            ...
            if (step === 5) {
                ...
                if (pipeline[0] === 'global' || pipeline[0] === 'monitor') {
                     ...
                     setServerStates(prev => { const n: ServerState[] = [...prev]; n[0] = "fire"; return n; });
