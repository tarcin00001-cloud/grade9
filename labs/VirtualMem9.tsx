                    ...
                    {queue.map(appId => {
                       ...
                       return (
                          <motion.div
                            ...
                            className={`bg-white border border-slate-300 border-b-[3px] shadow-sm rounded-lg p-2 flex flex-col items-center justify-center gap-1 md:gap-2 cursor-pointer hover:bg-slate-50 active:border-b-0 active:translate-y-[2px] transition-all w-20 h-20 md:w-24 md:h-24 shrink-0 z-20`}
                          >
